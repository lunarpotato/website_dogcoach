      ...
      >
        <div className="col-md-7">
          ...
          <p className="lead lead-text" style={{ wordBreak: "break-word" }}>
            ...
            Mensch-Hund und wie wir uns die Ressourcen von beiden Seiten zunutze
            machen können. Ich lernte sehr viel über Kommunikation, über
            Wechselwirkungen und darüber, dass unser Begleiter Hund uns Menschen
            immer wohlgesonnen ist und uns unterstützen möchte.
          </p>
        </div>
        <div>
          <img
